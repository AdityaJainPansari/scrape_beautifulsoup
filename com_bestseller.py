...
for x in page_content:
    ...
    for y in kaamhogaya:
        ...
        for z in hogaya:
            # print(z)
            temp1 = z.find(class_='p13n-sc-truncate p13n-sc-line-clamp-1')
            ...
            for a in temp2:
                if i == 1:
                    out_url = "www.amazon.com"+''.join(a['href'].rsplit())
                    i = 2
                    continue
                temp5 = a.get_text()
...
with open('./output/com_bestseller.csv', 'w', newline='') as csvfile:
